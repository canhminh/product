===========================================================
    ...
    |_| |_| |_|\__,_|\__, |_| |_|\___/|_|_|\__,_|
        ...
        14. February 2020
        v 6.2 (Snapshot: 2020.02.14 09:55:25)
        Community Edition
...
This package contains:
   ...
   Magnolia Core 6.2-SNAPSHOT
   magnolia-empty-webapp 6.2-SNAPSHOT
   magnolia-empty-webapp 6.2-SNAPSHOT
   Magnolia Internationalization Framework 6.2-SNAPSHOT
   Magnolia JAAS 6.2-SNAPSHOT
   Magnolia Mail module 5.5.3-SNAPSHOT
   magnolia-module-rssaggregator 2.6.3-SNAPSHOT
   Magnolia Rendering 6.2-SNAPSHOT
   Magnolia Templating 6.2-SNAPSHOT
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/6.2-SNAPSHOT.html
